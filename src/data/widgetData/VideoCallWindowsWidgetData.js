...
export default class VideoCallWindowsWidgetData extends WidgetData {
    constructor(options) {
        super(options);
    ...
    importFromWidget_ver0_1(widget_ver0_1) {
        ...
        if( widget_ver0_1.getBgColor ){
            this._bgColor = widget_ver0_1.bgColor;
        }
        if( widget_ver0_1.getFgColor ){
            this._fgColor = widget_ver0_1.fgColor;
        }
    }
