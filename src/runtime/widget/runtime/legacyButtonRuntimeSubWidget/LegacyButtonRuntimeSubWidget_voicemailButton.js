...
export default class LegacyButtonRuntimeSubWidget_voicemailCallButton extends LegacyButtonRuntimeSubWidget  {
    ...
    getRenderJsx(tooltipOfButtonWidget) {
        ...
        const hasCall = oc.getPhoneClient().getCallInfos().getCallInfoArray().length != 0;
        const iconJsx = this._getIconJsx();
        return <button title={tooltipOfButtonWidget} disabled={hasCall}
