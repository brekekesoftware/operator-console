...
export default class LegacyButtonWidgetSubData_oneTouchDialButton extends LegacyButtonWidgetSubData {
    ...
    constructor( dataOptions = null, subDataOptions, dataVersion = null  ) {
        ...
        if( dataVersion === "2.0.0"){
            ...
            this._number = subDataOptions["number"];
            this._onetouchdialMode = subDataOptions["onetouchdialMode"];
        }
        else if( oSubData  ){
    ...
    _exportLegacyButtonWidgetSubDataToWidgetSettingsTemplateMain( wst ){
        wst.setWidgetSettingsTemplateField( WidgetData.WIDGET_FIELD_NAME_ONETOUCHDIAL_BUTTON__NUMBER, this._number );
        wst.setWidgetSettingsTemplateField( WidgetData.WIDGET_FIELD_NAME_ONETOUCHDIAL_BUTTON__MODE, this._onetouchdialMode );
    ...
    _importLegacyButtonWidgetSubDataFromWidgetSettingsTemplateMain( wst ){
        if( wst.isWidgetSettingsTemplateFieldExists( WidgetData.WIDGET_FIELD_NAME_ONETOUCHDIAL_BUTTON__NUMBER ) === true ) {
            this._number = wst.getWidgetSettingsTemplateFieldValue(WidgetData.WIDGET_FIELD_NAME_ONETOUCHDIAL_BUTTON__NUMBER);
        }
        if( wst.isWidgetSettingsTemplateFieldExists( WidgetData.WIDGET_FIELD_NAME_ONETOUCHDIAL_BUTTON__MODE ) === true ) {
            this._onetouchdialMode = wst.getWidgetSettingsTemplateFieldValue(WidgetData.WIDGET_FIELD_NAME_ONETOUCHDIAL_BUTTON__MODE);
        }
