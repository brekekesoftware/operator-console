...
export default class LegacyButtonRuntimeSubWidget_hangUpCallButton extends LegacyButtonRuntimeSubWidget  {
    ...
    getRenderJsx() {
        ...
        let bDisabled;
        if( currentCallInfo ){
            const bIsTransffering = currentCallInfo.getIsTransferring();
            if( bIsTransffering ) {
                bDisabled = false;
            }
            else {
