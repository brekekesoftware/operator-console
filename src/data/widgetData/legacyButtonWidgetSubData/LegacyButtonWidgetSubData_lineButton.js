...
export default class LegacyButtonWidgetSubData_lineButton extends LegacyButtonWidgetSubData {
    ...
    constructor( dataOptions = null, subDataOptions, dataVersion = null  ) {
        ...
        if( dataVersion === "2.0.0"){
            ...
            this._line = subDataOptions["line"];
        }
        else if( oSubData  ){
    ...
    _exportLegacyButtonWidgetSubDataToWidgetSettingsTemplateMain( wst ){
        wst.setWidgetSettingsTemplateField( WidgetData.WIDGET_FIELD_NAME_LINE_BUTTON__LINE, this._line  );
    ...
    _importLegacyButtonWidgetSubDataFromWidgetSettingsTemplateMain( wst ){
        if( wst.isWidgetSettingsTemplateFieldExists( WidgetData.WIDGET_FIELD_NAME_LINE_BUTTON__LINE ) === true ) {
            this._line = wst.getWidgetSettingsTemplateFieldValue(WidgetData.WIDGET_FIELD_NAME_LINE_BUTTON__LINE );
        }
