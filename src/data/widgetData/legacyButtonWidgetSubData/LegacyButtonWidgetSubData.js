...
const _LEGACY_BUTTON_WIDGET_SUBTYPE_IDS = Object.freeze({   //[ subtypeKey : subtypeId ]
    dummy: 0,
    callTalking:1,
    noAnswer:2,
    callback:3,
...
const _LEGACY_BUTTON_WIDGET_SUBTYPE_NAMES = Object.freeze({ //[ subtypeId : subtypeName ]
	...
	35 : "LegacyVoicemailButton",
});
export default class LegacyButtonWidgetSubData{

    constructor( options = null, subDataOptions, dataVersion = null  ) {
        this._LegacyButtonWidgetDataAsParent = subDataOptions["legacyButtonWidgetDataAsParent"];
    ...
    exportLegacyButtonWidgetSubDataToWidgetSettingsTemplate( wst, editorWidgetSettings ){
        this._exportLegacyButtonWidgetSubDataToWidgetSettingsTemplateMain(wst, editorWidgetSettings );
    }
