...
export default class LegacyButtonRuntimeSubWidget_toggleHoldCallButton extends LegacyButtonRuntimeSubWidget  {
    ...
    getRenderJsx(tooltipOfButtonWidget) {
        ...
        if( bHolding ){
            ...
            return <button title={tooltipOfButtonWidget} className="kbc-button kbc-button-fill-parent"
                           ...
                           onClick={(!currentCallInfo || !currentCallInfo.getIsAnswered() || currentCallInfo.getIsHolding() ) ? undefined : oc.holdCall}
            >{holdIconJsx}</button>
        }
